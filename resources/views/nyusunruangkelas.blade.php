    ...
    <nav class="bg-gray-800" x-data="{ isOpen: false }">
      ...
      <header class="bg-white shadow">
        <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
          ...
          <a href="dashboard-kaprodi" class="text-3xl font-bold tracking-tight text-gray-900">Dashboard</a>
        </div>
      </header>
      ...
      <div class="container mx-auto mt-10">
        <div class="bg-white shadow-md rounded-lg">
            <div class="flex border-b">
                <button class="flex-1 py-4 px-6 text-center text-orange-500 border-b-2 border-orange-500">ARRANGE CLASSROOM</button>
                <button class="flex-1 py-4 px-6 text-center text-gray-500 hover" onclick="window.location.href='nyusunkuotakelas'">ARRANGE QUOTA CLASS</button>
            </div>
            <div class="p-6">
                <h2 class="text-center text-gray-700 font-medium mb-6">Arrange Classroom for informatics student</h2>
                <table class="min-w-full bg-white">
                    <thead>
                        <tr>
                            ...
                            <th class="py-2 px-4 border-b text-left text-gray-600">Jam</th>
                        </tr>
                    </thead>
                    <tbody>
                        <tr>
                            ...
                            <td class="py-2 px-4 border-b">07.00 - 09.30</td>
                        </tr>
                        <tr>
                            ...
                            <td class="py-2 px-4 border-b">13.00 - 15.30</td>
                        </tr>
                        <tr>
                            ...
                            <td class="py-2 px-4 border-b">09.40 - 12.10</td>
                        </tr>
                        <tr>
                            ...
                            <td class="py-2 px-4 border-b">15.30 - 17.40</td>
                        </tr>
                        <tr>
